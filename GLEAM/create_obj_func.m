function [H, F, inv_nsigma, sq, H_unm, F_unm, sq_unm] = create_obj_func(lnc_exp,sigma_c,G_exp_t,sigma_G_t,lb,ub,time_interval,tp,unm_meas)
% create_obj_func - creat the objective function for GLEAM
%
% Inputs:
%   lnc_exp : mean value vector of metabolite concentrations
%   sigma_c : standard variation vector of metabolite concentrations
%   G_exp_t : vector of the standard Gibbs free energy of formation transformed by transposed matrix of the eigenvectors of the variance-covariance matrix
%   sigma_G_t : standard variation vector of the standard Gibbs free energy of formation transformed by transposed matrix of the eigenvectors of the variance-covariance matrix
%   lb : lower bounds vector of metabolite concentrations
%   ub : upper bounds vector of metabolite concentrations
%   time_interval : vecter of intervals between time points of experiments
%   tp : sum of the number of time points
%   unm_meas : vector of indices of measured metabolite concentrations which is unmeasured at another time point
%
% Outputs:
