...
save('MouseData_KP.mat')

% calculate FCC
for i = 1:2000
    for j = 1:20 
        [By_rev_glyc_fcc_l(:,i,j), By_sat_s_glyc_fcc_l(:,i,j), By_sat_p_glyc_fcc_l(:,i,j),By_sat_unm_glyc_fcc_l(:,i,j)] = cal_etas(Ac,Af,By(:,i),glyc_rxn_l(2:end),evector_cov,RT,Km_By(:,:,i,j),d,14,0);
        [By_rev_glucon_fcc_l(:,i,j), By_sat_s_glucon_fcc_l(:,i,j), By_sat_p_glucon_fcc_l(:,i,j),By_sat_unm_glucon_fcc_l(:,i,j)] = cal_etas(Ac,Af,By(:,i),glucon_rxn_l(1:end-1),evector_cov,RT,Km_By(:,:,i,j),d,14,6);
        [By_rev_TCA0_fcc_l(:,i,j), By_sat_s_TCA0_fcc_l(:,i,j), By_sat_p_TCA0_fcc_l(:,i,j),By_sat_unm_TCA0_fcc_l(:,i,j)] = cal_etas(Ac,Af,By(:,i),TCA_rxn_l,evector_cov,RT,Km_By(:,:,i,j),d,14,0);
        [By_rev_TCA16_fcc_l(:,i,j), By_sat_s_TCA16_fcc_l(:,i,j), By_sat_p_TCA16_fcc_l(:,i,j),By_sat_unm_TCA16_fcc_l(:,i,j)] = cal_etas(Ac,Af,By(:,i),TCA_rxn_l,evector_cov,RT,Km_By(:,:,i,j),d,14,6);
